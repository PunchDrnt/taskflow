...
import { MemberService } from '../src/modules/organization/member/member.service'
...
import { Status } from '../src/modules/project/status/status.entity'
import { StatusService } from '../src/modules/project/status/status.service'
