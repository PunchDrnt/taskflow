...
- [x] 🔒 **`FeatureService.isEnabled()` return `true` เสมอ — "ดักด้วย feature flag" ตอนนี้แปลว่า "เปิดอยู่"**
      ...
      · `04-features.md` ไม่ต้องแก้ — โค้ดขยับมาตรงกับ doc · ที่แก้คือ [`02-database/README.md`](../docs/02-database/schema.md#schema-identity) กับ [`03-roadmap.md`](../docs/03-roadmap.md) ที่ยังเขียนว่า `return true`
