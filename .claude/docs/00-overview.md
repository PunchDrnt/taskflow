...
| `org_id` ทุกตาราง ยกเว้น schema `identity` + ต้องมี isolation test   | ข้อมูลข้ามบริษัทรั่ว — พลาดครั้งเดียวจบ                                    | [`02-database.md`](./02-database.md#3-multi-tenancy)                                           |
...
| Primary key เป็น UUID                                             | เปลี่ยนทีหลังต้องแตะทุก FK ทุกตาราง                                     | [`02-database.md`](./02-database.md#base-entity--on-every-table-no-exceptions)                 |
