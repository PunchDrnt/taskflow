...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        'fixed inset-0 z-50 bg-(--neutral-950)/40 transition-opacity duration-150 data-ending-style:opacity-0 data-starting-style:opacity-0 supports-backdrop-filter:backdrop-blur-xs',
        className,
      )}
      {...props}
    />
...
function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props) {
  return (
    <SheetPrimitive.Title
      ...
      className={cn(
        'font-kanit text-text-primary text-body-lg leading-none font-medium',
        className,
      )}
      {...props}
    />
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn('text-text-secondary text-body-md', className)}
      {...props}
    />
  )
}
